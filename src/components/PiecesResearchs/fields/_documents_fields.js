...
export const DocumentsFields = ({ Documents, setDocuments, actualDocs, langData }) => {
              ...
              <div className="row">
                ...
                <div
                  className={`col-4 text-${
                    colorFile[
                      fileTypes[
                        actualDocs?.[currentDocIndex]?.file?.type || "primary"
                      ]
                    ]
                  } mt-3`}
                >
                  ...
                  Documents[currentDocIndex]["file"] ? (
                    <div>
                      <FontAwesomeIcon
                        icon={
                          Documents && Documents[currentDocIndex]["file"]?.type
                            ? mimeIcons[Documents[currentDocIndex]["file"].type]
                            : faBan
                        }
                        size="3x"
                      />
